...
const trendOption = computed(() => ({
  ...
  legend:{data:['AUM总资产','AUM新增','AUM流失'],textStyle:{color:'#8899aa',fontSize:10},bottom:0},
...
.core-ring{position:absolute;border-radius:50%;border:1px solid transparent;
  &.o1{width:140px;height:140px;border-color:rgba(212,175,55,0.15);box-shadow:0 0 15px rgba(212,175,55,0.05),inset 0 0 15px rgba(212,175,55,0.05);animation:rotateRing 14s linear infinite;&::before{content:'';position:absolute;top:-1px;left:50%;width:16px;height:3px;background:#D4AF37;border-radius:2px;box-shadow:0 0 8px #D4AF37;transform:translateX(-50%)}}
  &.o2{width:75%;height:75%;border-color:rgba(0,207,255,0.1);animation:rotateRing 9s linear infinite reverse;&::before{content:'';position:absolute;top:-1px;left:50%;width:10px;height:2px;background:#00CFFF;border-radius:2px;box-shadow:0 0 6px #00CFFF;transform:translateX(-50%)}}
  &.o3{width:55%;height:55%;border-color:rgba(212,175,55,0.06);animation:rotateRing 6s linear infinite}
}
...
.core-lbl{font-size:9px;color:#8899aa;margin-bottom:2px;letter-spacing:2px}
...
.core-unit{font-size:11px;color:#6a7a8a}
.ripple{position:absolute;border-radius:50%;border:1px solid rgba(212,175,55,0.12);animation:rippleExpand 3.5s ease-out infinite;pointer-events:none;&.r1{width:160px;height:160px;animation-delay:0s}&.r2{width:180px;height:180px;animation-delay:1.2s}&.r3{width:200px;height:200px;animation-delay:2.4s}}
...
.wm-lbl{font-size:9px;color:#4a5a6a;flex:0 0 56px}
.wm-val{font-size:14px;font-weight:700;font-family:'Courier New',monospace;&.gold{color:#D4AF37}&.green{color:#00ff95}&.red{color:#ff5b5b}&.cyan{color:#00CFFF}}
.wm-unit{font-size:9px;color:#4a5a6a}
