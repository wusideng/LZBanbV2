...
const structureOption = computed(() => ({
  ...
  series:[{
    ...
    label:{color:'#8899aa',fontSize:12,formatter:'{b}'},
...
.rank-item{display:flex;align-items:center;gap:6px;height:24px;font-size:12px}
...
.rank-val{width:36px;text-align:right;color:#00CFFF;font-family:'Courier New',monospace;font-size:11px}
</style>